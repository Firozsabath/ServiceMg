...
import { DialogPartsupdateComponent } from 'src/app/admin/dialogs/dialog-service-request/dialog-partsupdate/dialog-partsupdate.component';
import { DialogRequeststatusupdateComponent } from 'src/app/admin/dialogs/dialog-service-request/dialog-requeststatusupdate/dialog-requeststatusupdate.component';
import { DialogServiceRequestComponent } from 'src/app/admin/dialogs/dialog-service-request/dialog-service-request.component';
import { DialogServicepartsComponent } from 'src/app/admin/dialogs/dialog-service-request/dialog-serviceparts/dialog-serviceparts.component';
import { ConfirmDialogModel } from 'src/app/models/ConfirmDialogModel';
import { ServiceParts } from 'src/app/models/ServiceParts';
import { ServiceRequestAttachments, ServiceRequestsVM, TechnicianNotesVM } from 'src/app/models/ServiceRequests';
